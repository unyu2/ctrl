...
@section('title')
Routine Maintenance Trainset 6
@endsection

<!--For 
Routine Maintenance Trainset 6
Routine Maintenance TRAINSET 6
<h3>{{ number_format ($PDFxTS6, 2) }}%</h3>
<h3>{{ number_format ($PDCxTS6, 2) }}%</h3>
<h3>{{ number_format ($PDNxTS6, 2) }}%</h3>
Replace-->
...
<div class="box-header with-border">
                <h3 class="active"><b>Routine Maintenance TRAINSET 6</b></h3>
            </div>
