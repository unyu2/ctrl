...
@section('title')
Routine Maintenance Trainset 4
@endsection

<!--For 
Routine Maintenance Trainset 4
Routine Maintenance TRAINSET 4
<h3>{{ number_format ($PDFxTS4, 2) }}%</h3>
<h3>{{ number_format ($PDCxTS4, 2) }}%</h3>
<h3>{{ number_format ($PDNxTS4, 2) }}%</h3>
Replace-->
...
<div class="box-header with-border">
                <h3 class="active"><b>Routine Maintenance TRAINSET 4</b></h3>
            </div>
