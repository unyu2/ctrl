...
@section('title')
Routine Maintenance Trainset 5
@endsection

<!--For 
Routine Maintenance Trainset 5
Routine Maintenance TRAINSET 5
<h3>{{ number_format ($PDFxTS5, 2) }}%</h3>
<h3>{{ number_format ($PDCxTS5, 2) }}%</h3>
<h3>{{ number_format ($PDNxTS5, 2) }}%</h3>
Replace-->
...
<div class="box-header with-border">
                <h3 class="active"><b>Routine Maintenance TRAINSET 5</b></h3>
            </div>
