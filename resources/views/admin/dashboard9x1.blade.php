...
@section('title')
Routine Maintenance Trainset 8
@endsection

<!--For 
Routine Maintenance Trainset 8
Routine Maintenance TRAINSET 8
<h3>{{ number_format ($PDFxTS8, 2) }}%</h3>
<h3>{{ number_format ($PDCxTS8, 2) }}%</h3>
<h3>{{ number_format ($PDNxTS8, 2) }}%</h3>
Replace-->
...
<div class="box-header with-border">
                <h3 class="active"><b>Routine Maintenance TRAINSET 8</b></h3>
            </div>
