...
@section('title')
Routine Maintenance Trainset 9
@endsection

<!--For 
Routine Maintenance Trainset 9
Routine Maintenance TRAINSET 9
<h3>{{ number_format ($PDFxTS9, 2) }}%</h3>
<h3>{{ number_format ($PDCxTS9, 2) }}%</h3>
<h3>{{ number_format ($PDNxTS9, 2) }}%</h3>
Replace-->
...
<div class="box-header with-border">
                <h3 class="active"><b>Routine Maintenance TRAINSET 9</b></h3>
            </div>
