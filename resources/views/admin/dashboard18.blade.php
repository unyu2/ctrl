...
@section('title')
    Dashboard Trainset 17
@endsection

<!--For 
Dashboard Trainset 17
TRAINSET 17
href="{{ route('dashboard18x1') }}"
href="{{ route('dashboard18x2') }}"
Replace-->

@section('breadcrumb')
    @parent
    <li class="active">Dashboard Trainset 17</li>
@endsection

@section('content')
@section('content')
<div class="box-header with-border">
                <h3 class="active"><b>TRAINSET 17</b></h3>
            </div>
...
<div class="row">
    ...
    <div class="col-lg-3 col-xs-7">
        ...
        <div class="small-box bg-yellow">
            ...
            <a href="{{ route('dashboard18x1') }}" class="small-box-footer">Lihat <i class="fa fa-arrow-circle-right"></i></a>
        </div>
    </div>
    <!-- ./col -->
    <div class="col-lg-3 col-xs-7">
        ...
        <div class="small-box bg-yellow">
            ...
            <a href="{{ route('dashboard18x2') }}" class="small-box-footer">Lihat <i class="fa fa-arrow-circle-right"></i></a>
        </div>
    </div>
    <!-- ./col -->
</div>
