...
@section('title')
    Dashboard Trainset 2
@endsection

@section('breadcrumb')
    @parent
    <li class="active">Dashboard Trainset 2</li>
@endsection

@section('content')
@section('content')
<div class="box-header with-border">
                <h3 class="active"><b>TRAINSET 2</b></h3>
            </div>
...
<div class="row">
    ...
    <div class="col-lg-3 col-xs-7">
        ...
        <div class="small-box bg-yellow">
            ...
            <a href="{{ route('dashboard3x1') }}" class="small-box-footer">Lihat <i class="fa fa-arrow-circle-right"></i></a>
        </div>
    </div>
    <!-- ./col -->
    <div class="col-lg-3 col-xs-7">
        ...
        <div class="small-box bg-yellow">
            ...
            <a href="{{ route('dashboard3x2') }}" class="small-box-footer">Lihat <i class="fa fa-arrow-circle-right"></i></a>
        </div>
    </div>
    <!-- ./col -->
</div>
