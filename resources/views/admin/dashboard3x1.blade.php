...
@section('title')
Routine Maintenance Trainset 2
@endsection
...
<div class="box-header with-border">
                <h3 class="active"><b>Routine Maintenance TRAINSET 2</b></h3>
            </div>
