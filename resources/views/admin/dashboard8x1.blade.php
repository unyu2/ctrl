...
@section('title')
Routine Maintenance Trainset 7
@endsection

<!--For 
Routine Maintenance Trainset 7
Routine Maintenance TRAINSET 7
<h3>{{ number_format ($PDFxTS7, 2) }}%</h3>
<h3>{{ number_format ($PDCxTS7, 2) }}%</h3>
<h3>{{ number_format ($PDNxTS7, 2) }}%</h3>
Replace-->
...
<div class="box-header with-border">
                <h3 class="active"><b>Routine Maintenance TRAINSET 7</b></h3>
            </div>
