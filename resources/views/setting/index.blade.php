        ...
        <div class="box">
            <form action="{{ route('setting.update') }}" method="post" class="form-setting" data-toggle="validator" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group row">
                        <label for="path_logo2" class="col-lg-2 control-label">Logo Sistem</label>
                        <div class="col-lg-4">
                            <input type="file" name="path_logo2" class="form-control" id="path_logo2"
                                onchange="preview('.tampil-logo2', this.files[0])">
                            <span class="help-block with-errors"></span>
                            <br>
                            <div class="tampil-logo2"></div>
                        </div>
                    </div>
                    <div class="form-group row">
    ...
    function showData() {
        $.get('{{ route('setting.show') }}')
            .done(response => {
                ...
                $('.tampil-logo2').html(`<img src="{{ url('/') }}${response.path_logo}" width="200">`);
